...
void add_trains()
{
    ...
    FILE *fp = fopen("h:\\Online C Project\\Railway Reservation System code and Pseudocode\\Railway Reservation System Files\\alltrains.dat", "rb");
    if (fp == NULL)
    {
        fp = fopen("h:\\Online C Project\\Railway Reservation System code and Pseudocode\\Railway Reservation System Files\\alltrains.dat", "wb");
...
int last_ticket_no()
{
    FILE *fp = fopen("h:\\Online C Project\\Railway Reservation System code and Pseudocode\\Railway Reservation System Files\\allbookings.dat", "rb");
    if (fp == NULL)
        return 0;
    Passenger pr;
...
int book_ticket(Passenger p)
{
    ...
    FILE *fp = fopen("h:\\Online C Project\\Railway Reservation System code and Pseudocode\\Railway Reservation System Files\\allbookings.dat", "ab");
    if (fp == NULL)
    {
        textcolor(LIGHTRED);
...
int cancel_ticket(int ticket_no)
{
    ...
    FILE *ft = fopen("h:\\Online C Project\\Railway Reservation System code and Pseudocode\\Railway Reservation System Files\\temp.dat", "wb");
    while (fread(&pr, sizeof(pr), 1, fp) == 1)
    {
        if (pr.ticketno == ticket_no)
        {
    ...
    if (found == 0)
    {
        remove("h:\\Online C Project\\Railway Reservation System code and Pseudocode\\Railway Reservation System Files\\temp.dat");
    }
    else
    {
        result = remove("h:\\Online C Project\\Railway Reservation System code and Pseudocode\\Railway Reservation System Files\\allbookings.dat");
        if (result != 0)
            return 2;
        result = rename("h:\\Online C Project\\Railway Reservation System code and Pseudocode\\Railway Reservation System Files\\temp.dat", "h:\\Online C Project\\Railway Reservation System code and Pseudocode\\Railway Reservation System Files\\allbookings.dat");
        if (result != 0)
            return 2;
    }
    return found;
